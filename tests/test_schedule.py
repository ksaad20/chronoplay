...
""",
    ...
    assert channel.entries[0].media.metadata == {"language": "en"}


def test_load_schedule_rejects_missing_file(tmp_path, channel_config):
...
def test_load_schedule_rejects_invalid_yaml(tmp_path, channel_config):
    path = write_schedule(
        tmp_path,
        """
schedule:
...
def test_load_schedule_requires_schedule_field(tmp_path, channel_config):
    path = write_schedule(
        tmp_path,
        "channel: test\n",
    )
...
def test_load_schedule_rejects_duplicate_entry_ids(tmp_path, channel_config):
    path = write_schedule(
        tmp_path,
        """
schedule:
