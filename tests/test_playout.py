...
def make_event(
    ...
    *,
    ...
    return ScheduleEvent(
        start=ScheduleEvent.__dataclass_fields__["start"].type
        if False
...
def test_custom_validator_failure_sets_error(
    tmp_path: Path,
) -> None:
    """A custom validator failure should enter the error state."""
